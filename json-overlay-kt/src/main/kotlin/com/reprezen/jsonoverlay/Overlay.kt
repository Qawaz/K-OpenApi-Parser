...
class Overlay<V> {
    ...
    fun toJson(options: SerializationOptions?): JsonElement {
        return overlay._toJson(options!!)
    }

    fun toJson(vararg options: SerializationOptions.Option): JsonElement {
        return overlay._toJson(*options)
    }
    ...
    companion object {
        ...
        fun <V> toJson(overlay: JsonOverlay<V>): JsonElement {
            return overlay._toJson()
        }

        fun <V> toJson(overlay: JsonOverlay<V>, options: SerializationOptions?): JsonElement {
            return overlay._toJson(options!!)
        }

        fun <V> toJson(overlay: JsonOverlay<V>, vararg options: SerializationOptions.Option): JsonElement {
            return overlay._toJson(*options)
        }

        fun getParsedJson(overlay: JsonOverlay<*>): JsonElement? {
