...
class LicenseImpl : PropertiesOverlay<License> ,License {
	...
	companion object {
		...
		val factory = object : OverlayFactory<License>() {
			...
			override fun _create(json : JsonNode, parent : JsonOverlay<*>?, refMgr : ReferenceManager) : JsonOverlay<License> {
		...
		private fun getSubtypeOf(json : JsonNode) : Class<out License> {
			return License::class.java
		}
